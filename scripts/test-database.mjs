...
for (const name of ["database-readiness.sql", "administration-readiness.sql", "access-administration.sql", "followup-lifecycle.sql", "reminder-readiness.sql", "duplicate-readiness.sql"]) {
