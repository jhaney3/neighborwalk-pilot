...
- [ ] Resolve guide-library pagination/concurrency and any other remaining integration/scale gaps recorded in the execution ledger. Do not silently omit inaccessible/malformed records or call truncated reads complete.
