...
- [ ] Resolve guide-library write/snapshot concurrency and any other remaining integration/scale gaps recorded in the execution ledger. Complete bounded reads now reject malformed/truncated collections; verify this behavior with the final write API and retained field cache.
