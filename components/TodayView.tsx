...
export function TodayView({ data, activeVolunteerId, canManage, onFollowUps, onPerson, onOuting, onReviewSync, onPeople }: {
  ...
  onFollowUps: () => void; onPerson: (id: string) => void; onOuting: (id?: string) => void;
